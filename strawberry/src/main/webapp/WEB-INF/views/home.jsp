...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="/strawberry/resources/img/core-img/favicon.ico">

  <!-- Core Stylesheet -->
  <link rel="stylesheet" href="/strawberry/resources/css/style.css">
  <link rel="stylesheet" href="/strawberry/resources/css/bootstrap.min.css">
  <link rel="stylesheet" href="/strawberry/resources/css/font-awesome.min.css">
  <link rel="stylesheet" href="/strawberry/resources/css/owl.carousel.min.css">
  <link rel="stylesheet" href="/strawberry/resources/css/animate.css">
  <link rel="stylesheet" href="/strawberry/resources/css/default-assets/audioplayer.css">
  <link rel="stylesheet" href="/strawberry/resources/css/default-assets/classy-nav.css">
  <link rel="stylesheet" href="/strawberry/resources/css/default-assets/hkgrotesk-fonts.css">
...
<body>
  ...
  <div id="preloader">
    <div class="preloader-thumbnail">
      <img src="/strawberry/resources/img/core-img/preloader.png" alt="">
    </div>
  </div>
    ...
    <div class="main-header-area">
      <div class="classy-nav-container breakpoint-off">
        ...
        <nav class="classy-navbar justify-content-between" id="pocaNav">
          ...
          <!-- Logo -->
          <a class="nav-brand" href="index.html"><img src="/strawberry/resources/img/core-img/logo.png" alt=""></a>
  ...
  <section class="welcome-area">
    ...
    <div class="welcome-slides owl-carousel">
      ...
      <div class="welcome-welcome-slide bg-img bg-overlay" style="background-image: url(/strawberry/resources/img/bg-img/1.jpg);">
            ...
            <div class="col-12">
              ...
              <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap" data-animation="fadeInUp" data-delay="900ms">
                <div class="poca-music-thumbnail">
                  <img src="/strawberry/resources/img/bg-img/4.jpg" alt="">
                </div>
                <div class="poca-music-content">
                  ...
                  <div class="poca-music-player">
                    <audio preload="auto" controls>
                      <source src="/strawberry/resources/audio/dummy-audio.mp3">
                    </audio>
                  </div>
      ...
      <!-- Single Welcome Slide -->
      <div class="welcome-welcome-slide bg-img bg-overlay" style="background-image: url(/strawberry/resources/img/bg-img/2.jpg);">
        <div class="container h-100">
          <div class="row h-100 align-items-center">
            <div class="col-12">
              <!-- Welcome Text -->
      ...
      <!-- Single Welcome Slide -->
      <div class="welcome-welcome-slide bg-img bg-overlay" style="background-image: url(/strawberry/resources/img/bg-img/3.jpg);">
        <div class="container h-100">
          <div class="row h-100 align-items-center">
            <div class="col-12">
              <!-- Welcome Text -->
      ...
      <div class="row poca-portfolio">
        ...
        <div class="col-12 col-md-6 single_gallery_item entre wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            <div class="poca-music-thumbnail">
              <img src="/strawberry/resources/img/bg-img/5.jpg" alt="">
            </div>
        ...
        <div class="col-12 col-md-6 single_gallery_item entre tutor wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            <div class="poca-music-thumbnail">
              <img src="/strawberry/resources/img/bg-img/6.jpg" alt="">
            </div>
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">December 9, 2018</span>
        ...
        <div class="col-12 col-md-6 single_gallery_item media wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            <div class="poca-music-thumbnail">
              <img src="/strawberry/resources/img/bg-img/7.jpg" alt="">
            </div>
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">December 9, 2018</span>
              <h2>Episode 203 - The Last Blockbuster</h2>
        ...
        <div class="col-12 col-md-6 single_gallery_item media wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            <div class="poca-music-thumbnail">
              <img src="/strawberry/resources/img/bg-img/8.jpg" alt="">
            </div>
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">December 9, 2018</span>
        ...
        <div class="col-12 col-md-6 single_gallery_item tech tutor wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            <div class="poca-music-thumbnail">
              <img src="/strawberry/resources/img/bg-img/9.jpg" alt="">
            </div>
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">December 9, 2018</span>
        ...
        <div class="col-12 col-md-6 single_gallery_item tech wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            <div class="poca-music-thumbnail">
              <img src="/strawberry/resources/img/bg-img/10.jpg" alt="">
            </div>
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">December 9, 2018</span>
      ...
      <div class="row justify-content-around">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="single-featured-guest mb-80">
            <img src="/strawberry/resources/img/bg-img/25.jpg" alt="">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="single-featured-guest mb-80">
            <img src="/strawberry/resources/img/bg-img/26.jpg" alt="">
            <div class="guest-info">
              <h5>Jayden White</h5>
              <span>DRUMMER</span>
            </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="single-featured-guest mb-80">
            <img src="/strawberry/resources/img/bg-img/27.jpg" alt="">
            <div class="guest-info">
              <h5>Vincent Reid</h5>
  ...
  <section class="poca-newsletter-area bg-img bg-overlay pt-50 jarallax" style="background-image: url(/strawberry/resources/img/bg-img/15.jpg);">
    <div class="container">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-footer-widget mb-80">
            ...
            <div class="app-download-button mt-30">
              <a href="#"><img src="/strawberry/resources/img/core-img/app-store.png" alt=""></a>
              <a href="#"><img src="/strawberry/resources/img/core-img/google-play.png" alt=""></a>
            </div>
          </div>
        </div>
  ...
  <!-- ******* All JS ******* -->
  <!-- jQuery js -->
  <script src="/strawberry/resources/js/jquery.min.js"></script>
  <!-- Popper js -->
  <script src="/strawberry/resources/js/popper.min.js"></script>
  <!-- Bootstrap js -->
  <script src="/strawberry/resources/js/bootstrap.min.js"></script>
  <!-- All js -->
  <script src="/strawberry/resources/js/poca.bundle.js"></script>
  <!-- Active js -->
  <script src="/strawberry/resources/js/default-assets/active.js"></script>
